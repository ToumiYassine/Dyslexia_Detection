...
subscription_key_imagetotext = "Box645w85Rn9WdOZf51rRNj80KSm8lJt6n3VLVXcRw1vfzR7Tw4pJQQJ99AKACYeBjFXJ3w3AAAAACOGIQdH"
endpoint_imagetotext = "https://imgtotext14.cognitiveservices.azure.com/"
...
api_key_textcorrection = "3a176408255a4bd4b184222426b89ccf"
...
def percentage_of_corrections(extracted_text):
    ...
    matches = my_tool.check(extracted_text)
    return (len(matches) / len(extracted_text.split())) * 100
...
too late to seek help.""")
    ...
    img1 = Image.open(r"C:\Users\ASUS-MSi\Desktop\Dyslexia_Detection-main\images\img1.jpg")
    st.image(img1)

    st.subheader("Dyslexia- Esprim")
    st.write("""
...
with tab2:
    ...
    with st.container():
        ...
        if image is not None:
            ...
            image_uploaded.save(r"C:\Users\ASUS-MSi\Desktop\Dyslexia_Detection-main\temp.jpg")
            st.image(image_uploaded, width=224)

        if st.button("Predict", help="click after uploading the correct image"):
            try:
                feature_array = get_feature_array(r"C:\Users\ASUS-MSi\Desktop\Dyslexia_Detection-main\temp.jpg")
...
#'''-------------------------------------------------------------------------------------------------------------------------------------------------------------------------'''
    ...
    def get_10_word_array(level: int):
        if (level == 1):
            voc = pd.read_csv(r"C:\Users\ASUS-MSi\Desktop\Dyslexia_Detection-main\data\intermediate_voc.csv")
