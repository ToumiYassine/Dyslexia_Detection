...
#'''-------------------------------------------------------------------------------------------------------------------------------------------------------------------------'''
    ...
    def get_10_word_array(level: int):
        if (level == 1):
            voc = pd.read_csv(r"intermediate_voc.csv")
...
with tab4:   
    ...
    def get_10_word_array(level: int):
        if (level == 1):
            voc = pd.read_csv(r"Cintermediate_voc.csv")
            arr = voc.squeeze().to_numpy()
            selected_list = random.sample(list(arr), 10)
            return selected_list
